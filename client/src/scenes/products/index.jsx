...
const Product = ({ _id, name, description, price, rating, category, supply, stat }) => {
	...
	return (
		<Card sx={{ backgroundImage: "none", bgcolor: theme.palette.background.alt, borderRadius: "0.55rem" }}>
			<CardContent>
			...
			<Collapse in={isExpanded} timeout="auto" unmountOnExit sx={{ color: theme.palette.neutral[300] }}>
				<CardContent>
					...
					<Typography>Yearly Sold This Year: {stat.yearlyTotalSoldUnits}</Typography>
				</CardContent>
			</Collapse>
		</Card>
	);
