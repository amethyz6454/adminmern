		...
		<AppBar sx={{ position: "static", background: "none", boxShadow: "none" }}>
			<Toolbar sx={{ justifyContent: "space-between" }}>
				...
				<FlexBetween>
					...
					<FlexBetween backgroundColor={theme.palette.background.alt} borderRadius={9} gap="3rem" p="0.1rem 1.5rem">
				...
				<FlexBetween gap="1.5rem">
					...
					<FlexBetween>
						...
						>
							...
							<ArrowDropDownOutlined sx={{ color: theme.palette.secondary[300], fontSize: 25 }} />
						</Button>
